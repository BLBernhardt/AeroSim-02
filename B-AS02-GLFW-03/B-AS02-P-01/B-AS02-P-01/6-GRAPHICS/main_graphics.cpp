...
void Render_2D_Win1( GLFWwindow* windows[3], GD_t* TMrx, Display_t* DSPL );
void Render_2D_Win2( GLFWwindow* windows[3], GD_t* TM_Stx, Display_t* DSPL, Cntrls_t* CTRL );
void Render_2D_Win3( GLFWwindow* windows[3], GD_t* TM_Stx, Display_t* DSPL );
void Render_2D_Win4( GLFWwindow* windows[4], GD_t* TM_Stx, Display_t* DSPL, Cntrls_t* CTRL );


void PFD_Exec( int offset_X , int offset_Y, GD_t* TM, Display_t* DSPL, Cntrls_t* CTRL );
void HSI_Map( GD_t* TM );
...
void Render_2D_Win2( GLFWwindow* windows[4], GD_t* TM_Stx, Display_t* DSPL, Cntrls_t* CTRL ) 
{
