...
//float AERO_D->Pitch_d    = 0;
//float AERO_D->Roll_d     = 0;
//float AERO_D->Speed_Knots  = 120;
//float AERO_D->Alt_Feet     = 0;
//float AERO_D->Heading_d  = 0;
...
struct                
{
  ...
  float Airspeed_meters_per_sec;
	...
	Pos_X = 320 + offset_X;  Pos_Y = -353 + offset_Y;
		PFD_AltTape(  Pos_X, Pos_Y,  AERO_D->Altitude_MSL_feet );  

	Pos_X = 275 + offset_X;  Pos_Y = -56 + offset_Y;
		PFD_AltTicker(   DG_X, DG_Y,  Pos_X, Pos_Y, offset_X, offset_Y, AERO_D->Altitude_MSL_feet );  

	Pos_X = -390 + offset_X;  Pos_Y = -350 + offset_Y;
		PFD_SpeedTape(  Pos_X, Pos_Y, AERO_D->AirSpeed_knots  ); 

	Pos_X = -390 + offset_X;  Pos_Y = -48 + offset_Y;
		PFD_SpeedTicker(  DG_X, DG_Y, Pos_X, Pos_Y, offset_X, offset_Y, AERO_D->AirSpeed_knots );

	Pos_X = 0 + offset_X;  Pos_Y = -520 + offset_Y;
		PFD_Heading( Pos_X, Pos_Y, AERO_D->Heading_d );
