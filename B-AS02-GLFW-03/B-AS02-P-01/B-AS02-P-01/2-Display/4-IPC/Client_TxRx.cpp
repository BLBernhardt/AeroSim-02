...
// Convert UDP 
//===============================================================================
void Convert_UDP_Msg(const uint8_t* buffer, size_t len, TM_Param_t* dst )
{
 ...
 //   printf("Debug: Received %zu bytes, converting %zu words\n", len, num_words ); // Temporary debug
    ...
    if( sizeof(TM_Param_t ) % 4 != 0  ) {
        // Handle remaining bytes( Stick_Enable, key, spinner )
        size_t remainder = sizeof(TM_Param_t ) % 4;
...
//===============================================================================
int  IPC_UDP_C_Rx(int sockfd, TM_Param_t* TMrx)   // 1=got packet, 0=no data, -1=error
{
