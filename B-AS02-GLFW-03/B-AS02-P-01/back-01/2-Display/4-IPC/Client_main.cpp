...
void UDP_init()
{
    ...
    IPC_UDP_C_Tx_init( &tx_sockfd, &tx_addr, CLIENT_TX_PORT, DEFAULT_IP );   // Send to Server
    IPC_UDP_C_Rx_init( &rx_sockfd, &rx_addr, SERVER_TX_PORT, DEFAULT_IP );   // Receive on Server's Tx port
