...
//====== Graphics ==============================
	...
	bool Update_Graphics( GLFWwindow* windows[3], Server_Tx_t* TMrx, Display_t* DSPL, Cntrls_t* CTRL );
	void Render_2D_Win1( GLFWwindow* windows[3], Server_Tx_t* TMrx, Display_t* DSPL );
	void Render_2D_Win2( GLFWwindow* windows[3], Server_Tx_t* TMrx, Display_t* DSPL, Cntrls_t* CTRL ); 
	void Render_2D_Win3( GLFWwindow* windows[3], Server_Tx_t* TMrx, Display_t* DSPL );
...
//======== IPC UDP ===============================
	...
	void TM_load( Server_Tx_t* TM_Stx, Client_Tx_t* TM_Ctx, Aerodyn_t* AERO_D );
...
bool Update_Graphics( GLFWwindow* windows[3], Server_Tx_t* TM_Stx, Display_t* DSPL, Cntrls_t* CTRL )
{
