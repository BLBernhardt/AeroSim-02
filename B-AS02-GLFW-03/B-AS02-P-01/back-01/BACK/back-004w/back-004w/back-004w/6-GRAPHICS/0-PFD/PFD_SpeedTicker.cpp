...
void PFD_SpeedTicker( int Pos_X, int Pos_Y, int Disp_Area_X, int Disp_Area_Y, int offset_X, int offset_Y, float IAS )
{
 char string[40];
 float size = 5.0;
 ...
 int window_y;
	...
	glPushMatrix();
		glTranslatef( Pos_X, Pos_Y, 0 );
 		...
 		glColor3ub( 1, 0, 0 ); // Draw black background
 		glBegin(GL_POLYGON);
 	...
 	glPushMatrix();
 		...
 		glfwGetFramebufferSize( glfwGetCurrentContext(), &window_x, &window_y ); // Window width and height 
