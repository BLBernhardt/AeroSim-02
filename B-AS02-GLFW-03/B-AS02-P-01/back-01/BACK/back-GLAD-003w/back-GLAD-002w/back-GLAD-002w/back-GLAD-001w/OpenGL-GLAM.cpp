...
// 	static Aerodyn_t  Aero_Dg = {0};
    ...
    if( interrupt_flag == 1 )  // Timer Interupt set for 1000 interupts per second. See Timer Initialization
    {
    	...
    	{   count_10 = 0;   	
			CTRLg.Elevator_Cmd = TMtxg.pitch_cmd;
			CTRLg.Aileron_Cmd  = TMtxg.roll_cmd;
			CTRLg.Rudder_Cmd   = TMtxg.yaw_cmd;
			CTRLg.Throttle_Cmd = TMtxg.thrtl_cmd;
		}		
...
//===================================================================
	...
	glfwSetWindowPos(window, 300, 100); 
 	...
 	glfwSwapInterval(0);   // 1 : monitor synce   0: is no synce. 
