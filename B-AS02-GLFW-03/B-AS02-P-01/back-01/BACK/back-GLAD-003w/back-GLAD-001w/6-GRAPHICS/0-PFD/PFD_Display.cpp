...
//float Aero_Dg.Pitch_d    = 0;
//float Aero_Dg.Roll_d     = 0;
//float Aero_Dg.Speed_Knots  = 120;
//float Aero_Dg.Alt_Feet     = 0;
//float Aero_Dg.Heading_d  = 0;
  ...
  float Airspeed_meters_per_sec;
	...
	//	Background( offset_X,  offset_Y );
        ...
        Pos_X = 0 + offset_X;  Pos_Y = 0 + offset_Y;
	       PFD_Attitude( Pos_X, Pos_Y, Aero_Dg.Pitch_d, Aero_Dg.Roll_d );

	Pos_X = 320 + offset_X;  Pos_Y = -353 + offset_Y;
		PFD_AltTape(  Pos_X, Pos_Y,  Aero_Dg.Altitude_MSL_feet );  

	Pos_X = 275 + offset_X;  Pos_Y = -56 + offset_Y;
		PFD_AltTicker(   DG_X, DG_Y,  Pos_X, Pos_Y, offset_X, offset_Y, Aero_Dg.Altitude_MSL_feet );  

	Pos_X = -390 + offset_X;  Pos_Y = -350 + offset_Y;
		PFD_SpeedTape(  Pos_X, Pos_Y, Aero_Dg.AirSpeed_knots  ); 

	Pos_X = -390 + offset_X;  Pos_Y = -48 + offset_Y;
		PFD_SpeedTicker(  DG_X, DG_Y, Pos_X, Pos_Y, offset_X, offset_Y, Aero_Dg.AirSpeed_knots );

	Pos_X = 0 + offset_X;  Pos_Y = -520 + offset_Y;
		PFD_Heading( Pos_X, Pos_Y, Aero_Dg.Heading_d );
