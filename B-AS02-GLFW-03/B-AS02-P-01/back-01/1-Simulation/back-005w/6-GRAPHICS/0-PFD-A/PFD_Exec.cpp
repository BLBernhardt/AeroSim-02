...
//extern struct Aerodyn_t TM;
//extern struct _Cntrls Cntrls;

void PFD_Exec( int, int );
void PFD_Attitude( int Pos_X, int Pos_Y, Server_Tx_t* TM );
void PFD_SpeedTicker( int, int, float );
void PFD_AltTicker( int, int, float );
...
void PFD_Display( Server_Tx_t* TM );



void PFD_Exec( int offset_X , int offset_Y, Cntrls_t *Cntrls, Server_Tx_t* TM, Display_t* DSPL )
{
// int DG_X, DG_Y;
 int Pos_X, Pos_Y;
 //float scale;
...
//			PFD_AltTape( Pos_X, Pos_Y, TM->Alt ); 
			...
			PFD_AltTicker( Pos_X, Pos_Y, TM->Alt ); 
...
//			PFD_SpeedTape( Pos_X, Pos_Y, TM->AirSpeed ); 
			...
			PFD_SpeedTicker( Pos_X, Pos_Y, TM->AirSpeed );
