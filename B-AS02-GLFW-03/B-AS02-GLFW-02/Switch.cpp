...
//struct _Frame       Frame;
struct Cntrls_t     	Cntr;
struct Display_t     	Dspl;
extern struct Electrical_t  	Elec;
//struct _Vehicle     Vehc;
...
int  Switch_Module( struct Switch_t, int, Electrical_t );





int SW_mode( int state0, Electrical_t Elec )
{
 struct Switch_t SW;
...
int SW_auto( int state0, Electrical_t Elec )
{
 struct Switch_t SW;
...
int SW_pwr( int state0, Electrical_t Elec )
{
 struct Switch_t SW;
...
// SW.ix = 780;
 ...
 sprintf( SW.legend[3], "PWR" );
  ...
  SW.pos_H[3]    =  2*size;
  SW.pos_V[3]    = 26*size;
  SW.leg_siz[3]  = 14*size;
  SW.leg_pos[3]  = 13*size;
  SW.lit_FB[3]   = FRONT;
...
int SW_eng( int state0, Electrical_t Elec )
{
 struct Switch_t SW;
...
int Switch_Module( struct Switch_t SW1, int state, Electrical_t Elec )
{
  int   i;
