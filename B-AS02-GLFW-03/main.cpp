...
//====== Aero Simulation =============================
    void Aero_Computations(float, Aerodyn_t*, Aero_Cntl_t*, Cntrls_t*);
...
//======== IPC UDP ===============================
	...
	void Interface_TM( TM_Stx_t* TM_in, TM_Ctx_t* TM_out, GD_IN_t* GD_in, Aero_Cntl_t* AERO_CTRL, Aerodyn_t* AERO_DYN,  Cntrls_t* CTRL  );
...
// 50 FPS 	
		...
		{ count_20 = 0;
			...
			float dt = 0.020; // sec.	
			Interface_TM( &TM_in, &TM_out, &GD_in, &AERO_CTRL, &AERO_D, CTRL  );
