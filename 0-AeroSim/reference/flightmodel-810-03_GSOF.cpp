...
//===========================================================================================================
// Quaternions
 	static Vec3 	W 			= { 0.0F, 0.0F, 0.0F };
 	static Qtrn4f 	_q 			= { 1.0F, 0.0F, 0.0F, 0.0F }; // initial orientation	
 	static Vec3 	Vinf_V 		= { 0.0F, 0.0F, 0.0F };	
...
//================== Init ====================================================================================================
 	if( init )
 	{
		...
		Vw 					= 0.0F;
		Vu 					= V_CRUISE;
		Altitude_m 			= ALT_INIT / 3.28084F; 			// 1 ft = 3.28094 meters
