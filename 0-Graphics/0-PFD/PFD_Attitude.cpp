...
void PFD_Attitude( int Pos_X, int Pos_Y, float Pitch, float Roll )
{
  //char string[40];
float fontHeight = .30;
  ...
  start  = M_PI * 267.0f / 180.0f;
   ...
   glColor3f(0.0f, 0.0f, 0.0f);
    ...
    glBegin(GL_POLYGON);
      glVertex2i(  240, -500 - Pos_Y );
      glVertex2i(  240,  500 - Pos_Y );
      glVertex2i(  500 - Pos_X,  500 - Pos_Y );
      glVertex2i(  500 - Pos_X, -500 - Pos_Y );
    glEnd();
    ...
    glBegin(GL_POLYGON);
      glVertex2i(  -400 + Pos_X, -500 - Pos_Y );
      glVertex2i(  -400 + Pos_X,  500 - Pos_Y );
      glVertex2i(  -240,  500 - Pos_Y );
      glVertex2i(  -240, -500 - Pos_Y );
    glEnd();
...
float Pa, Pb;
    ...
    glBegin(GL_LINE_LOOP);  // Use GL_POLYGON for a filled circle
